...
set yrange [ 3.00000 : 15.0000 ] noreverse writeback
...
GNUTERM = "wxt"
plot '< head -n 24 ./uji3.xyz' using 2:1 w p ps 1 lc "blue" pt 5 notit, '' using 2:($1+0.9):(sprintf("p%d", $0)) with labels notitle
#    EOF
